...
def test_failed_to_extract_regions(mocker, location_scraper):
    mock_get_soup = mocker.patch.object(
        target=location_scraper,
        attribute='get_soup',
        return_value=None
...
def test_failed_to_extract_prefectures(mocker, location_scraper):
    mock_get_soup = mocker.patch.object(
        target=location_scraper,
        attribute='get_soup',
        return_value=None
...
def test_failed_to_extract_prefectures_and_cities(mocker, location_scraper):
    mock_get_soup = mocker.patch.object(
        target=location_scraper,
        attribute='get_soup',
        return_value=None
